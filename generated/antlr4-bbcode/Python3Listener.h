...
public:
  ...
  virtual void enterIndex(Python3Parser::IndexContext *ctx) = 0;
  virtual void exitIndex(Python3Parser::IndexContext *ctx) = 0;

  virtual void enterSlice(Python3Parser::SliceContext *ctx) = 0;
  virtual void exitSlice(Python3Parser::SliceContext *ctx) = 0;

  virtual void enterStartindex(Python3Parser::StartindexContext *ctx) = 0;
  virtual void exitStartindex(Python3Parser::StartindexContext *ctx) = 0;

  virtual void enterEndindex(Python3Parser::EndindexContext *ctx) = 0;
  virtual void exitEndindex(Python3Parser::EndindexContext *ctx) = 0;

  virtual void enterStep(Python3Parser::StepContext *ctx) = 0;
  virtual void exitStep(Python3Parser::StepContext *ctx) = 0;
  ...
  virtual void enterTuple(Python3Parser::TupleContext *ctx) = 0;
  virtual void exitTuple(Python3Parser::TupleContext *ctx) = 0;

  virtual void enterList(Python3Parser::ListContext *ctx) = 0;
  virtual void exitList(Python3Parser::ListContext *ctx) = 0;

  virtual void enterComprehension(Python3Parser::ComprehensionContext *ctx) = 0;
  virtual void exitComprehension(Python3Parser::ComprehensionContext *ctx) = 0;

  virtual void enterLc_expr(Python3Parser::Lc_exprContext *ctx) = 0;
  virtual void exitLc_expr(Python3Parser::Lc_exprContext *ctx) = 0;

  virtual void enterFor_expr(Python3Parser::For_exprContext *ctx) = 0;
  virtual void exitFor_expr(Python3Parser::For_exprContext *ctx) = 0;

  virtual void enterIf_expr(Python3Parser::If_exprContext *ctx) = 0;
  virtual void exitIf_expr(Python3Parser::If_exprContext *ctx) = 0;
