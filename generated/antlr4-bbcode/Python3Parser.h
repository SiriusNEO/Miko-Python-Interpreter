...
public:
  ...
  enum {
    ...
    RuleIndex = 31, RuleSlice = 32, RuleStartindex = 33, RuleEndindex = 34, 
    RuleStep = 35, RuleTrailer = 36, RuleAtom = 37, RuleTuple = 38, RuleList = 39, 
    RuleComprehension = 40, RuleLc_expr = 41, RuleFor_expr = 42, RuleIf_expr = 43, 
    RuleTestlist = 44, RuleArglist = 45, RuleArgument = 46
  };
  ...
  public:
    ...
    std::vector<antlr4::tree::TerminalNode *> COLON();
    antlr4::tree::TerminalNode* COLON(size_t i);
    StartindexContext *startindex();
    EndindexContext *endindex();
    StepContext *step();
  ...
  class  StartindexContext : public antlr4::ParserRuleContext {
  public:
    StartindexContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    TestContext *test();
  ...
  class  EndindexContext : public antlr4::ParserRuleContext {
  public:
    EndindexContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    TestContext *test();
  ...
  public:
    ...
    TestContext *test();
    antlr4::tree::TerminalNode *CLOSE_BRACK();
    std::vector<Lc_exprContext *> lc_expr();
    Lc_exprContext* lc_expr(size_t i);
  ...
  class  Lc_exprContext : public antlr4::ParserRuleContext {
  public:
    Lc_exprContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
