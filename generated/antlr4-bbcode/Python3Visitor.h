...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitIndex(Python3Parser::IndexContext *context) = 0;

    virtual antlrcpp::Any visitSlice(Python3Parser::SliceContext *context) = 0;

    virtual antlrcpp::Any visitStartindex(Python3Parser::StartindexContext *context) = 0;

    virtual antlrcpp::Any visitEndindex(Python3Parser::EndindexContext *context) = 0;

    virtual antlrcpp::Any visitStep(Python3Parser::StepContext *context) = 0;
    ...
    virtual antlrcpp::Any visitTuple(Python3Parser::TupleContext *context) = 0;

    virtual antlrcpp::Any visitList(Python3Parser::ListContext *context) = 0;

    virtual antlrcpp::Any visitComprehension(Python3Parser::ComprehensionContext *context) = 0;

    virtual antlrcpp::Any visitLc_expr(Python3Parser::Lc_exprContext *context) = 0;

    virtual antlrcpp::Any visitFor_expr(Python3Parser::For_exprContext *context) = 0;

    virtual antlrcpp::Any visitIf_expr(Python3Parser::If_exprContext *context) = 0;
