...
public:
  ...
  virtual antlrcpp::Any visitIndex(Python3Parser::IndexContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitSlice(Python3Parser::SliceContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitStartindex(Python3Parser::StartindexContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitEndindex(Python3Parser::EndindexContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitStep(Python3Parser::StepContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitTuple(Python3Parser::TupleContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitList(Python3Parser::ListContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitComprehension(Python3Parser::ComprehensionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitLc_expr(Python3Parser::Lc_exprContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitFor_expr(Python3Parser::For_exprContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitIf_expr(Python3Parser::If_exprContext *ctx) override {
    return visitChildren(ctx);
  }
